...
#RUN apt-get update && apt-get install -y netselect libboost-system1.67.0 libboost-system1.67-dev libboost-program-options1.67-dev libboost-program-options1.67.0 libboost-locale1.67.0 libboost-thread1.67.0 libboost-filesystem1.67.0 libboost-atomic1.67.0 libboost-chrono1.67.0 libboost-date-time1.67.0 libboost-iostreams1.67.0 libssl1.1 libmariadb3
